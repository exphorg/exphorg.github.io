...
top.frames["d_pers"].document.getElementById("t").innerHTML="<a href=\"#\" onclick=\"AddJS(1,'scripts/ItemOperationCity2.js');\" style=margin-left:70%; title="+a+">[Раздеть]</a>";
...
top.frames["d_pers"].document.getElementById("t").innerHTML=""
+"<a href=\"#\" onclick=\"AddJS(1,'scripts/ItemOperationCity2.js');\" style=margin-left:70%; title="+a+">[Раздеть]</a>";
document.location="room_mode_0_type_7.chtml";
}}
}
if(a==3) {
