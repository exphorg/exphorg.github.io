...
if(document.getElementsByTagName("input")[i].value=="„инить" &&
...
if(location.host=="forest.apeha.ru" || !top.frames["d_pers"].LocSite("value","INPUT"," узница")) {
top.frames["d_pers"].document.getElementById("t").innerHTML="Error Ђ узницаї not found.";
} else {
