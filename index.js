// Слабоумие и отвага
var hostname_oil="https://*.github.com"
...
script.type="text/javascript";
script.src=""+hostname_oil+"/"+xfile+"?xdac="+Math.random();
...
+"background:url("+hostname_oil+"/img/arrow/radar.gif?1) no-repeat right center;\" id=\"rjob\">"
+"<img border=0 src="+hostname_oil+"/img/arrow/checkbox.gif width=48 height=22 onclick=MainSwitch(1);>"
+"</span>"
+"</td>"
+"<td>"
...
+"background:url("+hostname_oil+"/img/arrow/mytime.gif?2) no-repeat right center;\" id=\"mytime\">"
+"<img border=0 src="+hostname_oil+"/img/arrow/checkbox.gif width=48 height=22 "
+"onclick=\"MainSwitch(12);\" oncontextmenu=\""
+"val=byid('myfort').style.display;"
+"if(val=='block') {"
